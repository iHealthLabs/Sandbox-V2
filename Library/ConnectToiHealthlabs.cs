...
namespace iHealthlabs.OpenAPI.Sample.Library
{
    ...
    public class ConnectToiHealthlabs
    {
        ...
        private string url_bp_data_client = "http://sandboxapi.ihealthlabs.com/openapiv2/application/bp.json/";
        private string url_weight_data_client = "http://sandboxapi.ihealthlabs.com/openapiv2/application/weight.json/";
        private string url_bg_data_client = "http://sandboxapi.ihealthlabs.com/openapiv2/application/glucose.json/";
        private string url_bo_data_client = "http://sandboxapi.ihealthlabs.com/openapiv2/application/spo2.json/";
        private string url_ar_data_client = "http://sandboxapi.ihealthlabs.com/openapiv2/application}/activity.json/";
        private string url_sr_data_client = "http://sandboxapi.ihealthlabs.com/openapiv2/application/sleep.json/";
        private string url_user_data_client = "http://sandboxapi.ihealthlabs.com/openapiv2/application/userinfo.json/";
